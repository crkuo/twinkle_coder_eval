...
def make_chat_prompt(prompt: str, tokenizer=None, response_prefix: str = "") -> str:
    """
    ...
    if tokenizer.chat_template:
        ...
        if (
            "ckpt" in tokenizer.name_or_path
            or "checkpoint" in tokenizer.name_or_path
            or "ckp" in tokenizer.name_or_path
        ):
